...
function urunleriGetir($baglanti, $kategori_id) {
    $stmt = $baglanti->prepare("SELECT * FROM dbo.Ürün WHERE KategoriID = ?");
...
<section class="urunler-bolumu">
  ...
  <div class="urunler-grid">
    <?php foreach ($elbiseler as $Ürün): ?>
      <div class="urun-karti">
        <img src="<?= $Ürün['GörselURL'] ?>" alt="<?= $Ürün['Ad'] ?>">
        <h4><?= $Ürün['Ad'] ?></h4>
        <p><?= $Ürün['Fiyat'] ?> TL</p>
        <button class="sepete-ekle" data-isim="<?= $Ürün['Ad'] ?>" data-fiyat="<?= $Ürün['Fiyat'] ?>">Sepete Ekle</button>
      </div>
    <?php endforeach; ?>
  </div>
  ...
  <h2>Pantolon</h2>
  <div class="urunler-grid">
    <?php foreach ($ayakkabilar as $Ürün): ?>
      <div class="urun-karti">
        <img src="<?= $Ürün['GörselURL'] ?>" alt="<?= $Ürün['Ad'] ?>">
        <h4><?= $Ürün['Ad'] ?></h4>
        <p><?= $Ürün['Fiyat'] ?> TL</p>
  ...
  <h2>Ayakkabılar</h2>
  <div class="urunler-grid">
    <?php foreach ($aksesuarlar as $Ürün): ?>
      <div class="urun-karti">
        <img src="<?= $Ürün['GörselURL'] ?>" alt="<?= $Ürün['Ad'] ?>">
        <h4><?= $Ürün['Ad'] ?></h4>
        <p><?= $Ürün['Fiyat'] ?> TL</p>
