  ...
  <h2>Erkek Ayakkabıları</h2>
    <div class="urunler-grid">
        <div class="urun-karti">
            <img src="" alt="Erkek Spor Ayakkabı">
            <h4>Günlük Erkek Spor Ayakkabı</h4>
            <p>599 TL</p>
            <button class="sepete-ekle" data-isim="Günlük Erkek Spor Ayakkabı" data-fiyat="599">Sepete Ekle</button>
        </div>
        <div class="urun-karti">
            <img src="" alt="Erkek Klasik Ayakkabı">
            <h4>Deri Erkek Klasik Ayakkabı</h4>
            <p>749 TL</p>
            <button class="sepete-ekle" data-isim="Deri Erkek Klasik Ayakkabı" data-fiyat="749">Sepete Ekle</button>
        </div>
        <div class="urun-karti">
            <img src="" alt="Erkek Bot">
            <h4>Erkek Kışlık Bot</h4>
            <p>699 TL</p>
            <button class="sepete-ekle" data-isim="Erkek Kışlık Bot" data-fiyat="699">Sepete Ekle</button>
        </div>
        <div class="urun-karti">
            <img src="" alt="Erkek Günlük Ayakkabı">
            <h4>Rahat Erkek Günlük Ayakkabı</h4>
            <p>449 TL</p>
            <button class="sepete-ekle" data-isim="Rahat Erkek Günlük Ayakkabı" data-fiyat="449">Sepete Ekle</button>
        </div>
        <div class="urun-karti">
            <img src="" alt="Erkek Sneaker">
            <h4>Trend Erkek Sneaker</h4>
            <p>649 TL</p>
            <button class="sepete-ekle" data-isim="Trend Erkek Sneaker" data-fiyat="649">Sepete Ekle</button>
        </div>
    </div>
  <h2>Erkek Ceketleri</h2>
    <div class="urunler-grid">
        <div class="urun-karti">
            <img src="" alt="Deri Ceket">
            <h4>Şık Deri Ceket</h4>
            <p>799 TL</p>
            <button class="sepete-ekle" data-isim="Şık Deri Ceket" data-fiyat="799">Sepete Ekle</button>
        </div>
        <div class="urun-karti">
            <img src="" alt="Kot Ceket">
            <h4>Casual Kot Ceket</h4>
            <p>499 TL</p>
            <button class="sepete-ekle" data-isim="Casual Kot Ceket" data-fiyat="499">Sepete Ekle</button>
        </div>
        <div class="urun-karti">
            <img src="" alt="Spor Ceket">
            <h4>Hafif Spor Ceket</h4>
            <p>549 TL</p>
            <button class="sepete-ekle" data-isim="Hafif Spor Ceket" data-fiyat="549">Sepete Ekle</button>
        </div>
        <div class="urun-karti">
            <img src="" alt="Trençkot">
            <h4>Klasik Trençkot</h4>
            <p>649 TL</p>
            <button class="sepete-ekle" data-isim="Klasik Trençkot" data-fiyat="649">Sepete Ekle</button>
        </div>
        <div class="urun-karti">
            <img src="" alt="Bomber Ceket">
            <h4>Trend Bomber Ceket</h4>
            <p>599 TL</p>
            <button class="sepete-ekle" data-isim="Trend Bomber Ceket" data-fiyat="599">Sepete Ekle</button>
        </div>
    </div>
